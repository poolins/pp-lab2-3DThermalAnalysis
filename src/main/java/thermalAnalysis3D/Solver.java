...
public class Solver {
    ...
    static void step(double[][][] t0, double[][][] t1, int sizeX, int sizeY, int sizeZ,
                     double dx, double dy, double dz, double dt, int T,
    ...
    private static void keyStep(double[][][] t0, double[][][] t1, int sizeX, int sizeY, int sizeZ,
                                double dx, double dy, double dz, double dt, int a,
    ...
    static void calculate(double[][][] tInit, int nX, int nY, int nZ, int iterations, int temp) throws InterruptedException {
        double dx = 1.0 / nX;
        double dy = 1.0 / nY;
        double dz = 1.0 / nZ;
        double dt = 0.005;
